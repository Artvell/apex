# Generated by Django 2.2 on 2019-04-02 15:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ostat', models.FloatField(default=0.0, verbose_name='Осталось на складе')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='roles.Receivers', verbose_name='Кому')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='roles.Pizzerias', verbose_name='Пиццерия')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Работник')),
            ],
            options={
                'verbose_name': 'Роль',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dop_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='roles.Dop_types', verbose_name='Тип расхода')),
                ('nak_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='roles.Purchase', verbose_name='Номер накладной')),
            ],
            options={
