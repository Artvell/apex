...
urlpatterns = [
    ...
    path('accounts/profile/sklad/',views.profile),
    path('accounts/profile/kassir/',views.profile),
    path('accounts/profile/zagot/',views.profile),
    path('accounts/profile/zakup/',views.profile),
    path('about_product/',views.product_name),
    path('close_rediscount/',views.close_rediscount),
    path('accounts/profile/info',views.info),
    path('accounts/profile/receipt/',views.info_table),
    path('accounts/profile/all_receipt/',views.all_receipt),
    path('accounts/profile/all_consumption/',views.all_consumption),
    path('accounts/profile/consumption/',views.info_table),
    path('accounts/profile/rediscount/',views.barcode_for_rediscount),
    path('accounts/profile/product_rediscount/',views.product_for_rediscount),
    path('accounts/profile/info_about_rediscount/',views.info_about_rediscount),
    path('accounts/profile/all_rediscounts_info/',views.all_rediscounts),
    ...
    path('accounts/profile/list_no_nakl/',views.list_product_without_nakl),
    path('accounts/profile/products_no_nakl/',views.products_without_nakl),
    ...
    path('accounts/profile/remove_spis/',views.query_to_remove_spis),
    ...
    path('accounts/profile/add_new_product/',views.add_new_product),
    ...
    path('decode_barcode/',views.decode_barcode_from_image),
    path('accounts/profile/list_of_debts/',views.list_of_debts),
    path('accounts/profile/list_of_debts/borrowed/',views.borrowed_products),
